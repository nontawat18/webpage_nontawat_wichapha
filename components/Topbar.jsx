      ...
      <Container maxWidth="lg" className={roboto.className}>
        <Grid container spacing={2}>
          <Grid item xs={12} lg={6} md={6}>
            ...
            >
              {value === 1 && <strong className="strong-para-top">Store</strong>}
              {value === 2 && <strong className="strong-para-top">About Us</strong>}
              {value === 3 && <strong className="strong-para-top">Contact Us</strong>}
              {value === 4 && <strong className="strong-para-top">My Account</strong>}
            </Box>
